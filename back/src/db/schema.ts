...
# gold_daily_sales (location_name, order_date, order_count, revenue, avg_order_value, dine_in_orders, delivery_orders, takeout_orders, dine_in_revenue, delivery_revenue, takeout_revenue, toast_orders, doordash_orders, square_orders, total_tips, total_delivery_fees, total_commission, total_tax)
  → Pre-aggregated daily metrics by location. Use for dashboards and daily summaries.
...
# gold_category_performance (category_name, products_in_category, orders_containing, total_units_sold, total_revenue, avg_item_price, toast_revenue, doordash_revenue, square_revenue)
  → Pre-aggregated category analytics. Use for menu performance analysis.
